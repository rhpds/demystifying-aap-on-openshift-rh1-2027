# demystifying-aap-on-openshift-rh1-2027

Hands on lab providing attendees with functioning AAP clusters, letting them break the cluster, then providing them with the troubleshooting steps to recover.

**Owner:** rl-rh
**Migrated from:** https://github.com/rhpds/demystifying-aap-on-ocp-showroom.git
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/demystifying-aap-on-openshift-rh1-2027`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/demystifying-aap-on-openshift-rh1-2027
   ```
3. `cd demystifying-aap-on-openshift-rh1-2027`
